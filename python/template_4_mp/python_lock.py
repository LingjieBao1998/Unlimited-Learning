...
if __name__ == '__main__':
    ...
    # Employing `multiprocessing.Lock` is imperative to uphold data integrity and prevent race conditions whenever numerous processes necessitate concurrent access to shared resources.
